...
class SimInfoWindow(QMainWindow):
    ...
    def auto_sync_on_startup(self):
        ...
        try:
            from sms_log import sync_logs_from_network_to_local, sync_logs_from_local_to_network
    ...
    def periodic_sync(self):
        """ซิงค์แบบ periodic"""
        try:
            from sms_log import sync_logs_from_local_to_network
            if sync_logs_from_local_to_network():
    ...
    def send_sms_main(self):
        ...
        if not self.sims or not self.sims[0].imsi.isdigit():
            ...
            from sms_log import log_sms_sent
